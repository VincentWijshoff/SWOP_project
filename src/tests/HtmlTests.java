...
public class HtmlTests {
    ...
    public void setup() throws InvocationTargetException, InterruptedException {
        ...
        this.loader = new HtmlLoader(screen.getDocArea().getFocusedPane());
    ...
    void html_1_aTag(){
        ...
        String htmlCode = """
                ...
                """;
        screen.getDocArea().getFocusedPane().clearDocObjects();
        ...
        assertTrue(testName, containsGUILinkWithPos(ChildPane.xOffset, docarea.getRelativeYPos(), "TEXT", "", screen.getDocArea().getDrawnGUIObjects()));
    }
    ...
    void html_3_aTag(){
        ...
        assertTrue(testName, containsGUILinkWithPos(ChildPane.xOffset, docarea.getRelativeYPos(), "TEXT", "a.html", renderedObjects));
        assertTrue(testName, containsGUILinkWithPos(ChildPane.xOffset, docarea.getRelativeYPos() + 2*fm.getHeight() + 2*GUITable.yMargin, "Text", "b.html", renderedObjects));
        assertTrue(testName, containsGUILinkWithPos(ChildPane.xOffset, docarea.getRelativeYPos() + fm.getHeight() + GUITable.yMargin, "TEXT", "", renderedObjects));
    ...
    void html_1_tableTag(){
        ...
        assertTrue(testName, containsGUIStringWithPos(ChildPane.xOffset, docarea.getRelativeYPos(), "DATA", renderedObjects));
        assertTrue(testName, containsGUIStringWithPos(ChildPane.xOffset + fm.stringWidth("DATA") + GUITable.xMargin, docarea.getRelativeYPos() + fm.getHeight() + GUITable.yMargin, "SECOND COLUMN", renderedObjects));
        assertTrue(testName, containsGUIStringWithPos(ChildPane.xOffset, docarea.getRelativeYPos() + fm.getHeight() + GUITable.yMargin, "DATA", renderedObjects));
    }
    ...
    void html_2_tableTag(){
        ...
        String htmlCode = """
				...
				""";
        screen.getDocArea().getFocusedPane().clearDocObjects();screen.getDocArea().getFocusedPane().clearDocObjects();
        this.loader.initialise(htmlCode);
        loader.loadPage();
        DocumentArea docarea = screen.getDocArea();
